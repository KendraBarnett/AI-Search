...
export default function TraditionalSearch() {
  return (
    <article>
      ...
      <header>
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">How Traditional Search Works</h1>
      ...
      <section className="my-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">The Four-Step Model</h2>

        <section className="mb-6">
          <h3 className="text-xl font-semibold text-gray-800 mb-2">1. Crawling</h3>
          <p className="text-gray-700 leading-relaxed">Googlebot and other search engine crawlers systematically browse the web, following links from page to page to discover new and updated content. Crawlers respect robots.txt directives and follow sitemaps to find pages efficiently. The frequency of crawling depends on the site's authority, update frequency, and technical accessibility.</p>
        </section>

        <section className="mb-6">
          <h3 className="text-xl font-semibold text-gray-800 mb-2">2. Indexing</h3>
          <p className="text-gray-700 leading-relaxed">Once crawled, Google processes and stores the page's content in its massive index — a database of hundreds of billions of web pages. During indexing, Google analyzes the page's text, images, and metadata to understand what the page is about. Pages that are duplicate, low-quality, or blocked by noindex directives are excluded from the index.</p>
        </section>

        <section className="mb-6">
          <h3 className="text-xl font-semibold text-gray-800 mb-2">3. Ranking</h3>
          <p className="text-gray-700 leading-relaxed">When a user enters a query, Google's algorithms score indexed pages against 200+ ranking signals to determine the most relevant results. Key signals include keyword relevance, backlink quality, page speed, mobile-friendliness, content depth, and user engagement patterns. The algorithm produces a ranked list ordered by estimated relevance and quality.</p>
        </section>

        <section className="mb-6">
          <h3 className="text-xl font-semibold text-gray-800 mb-2">4. Display</h3>
          <p className="text-gray-700 leading-relaxed">Users see a <dfn>Search Engine Results Page (SERP)</dfn> — a ranked list of blue links, often accompanied by featured snippets, knowledge panels, ads, and (increasingly) AI Overviews. The user clicks a link, visits the website, and finds their answer. This click-through model is the foundation of digital marketing measurement.</p>
        </section>
      </section>

      <section className="my-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">How Brands Win with Traditional SEO</h2>

        <section className="mb-4">
          <h3 className="text-xl font-semibold text-gray-800 mb-2">Keywords</h3>
          <p className="text-gray-700 leading-relaxed">Matching user search terms with optimized on-page content. Keyword research identifies high-intent terms, and content is structured to satisfy the search intent behind those terms.</p>
        </section>

        <section className="mb-4">
          <h3 className="text-xl font-semibold text-gray-800 mb-2">Backlinks</h3>
          <p className="text-gray-700 leading-relaxed key-answer">Earning authority signals from other websites — still the primary authority signal in traditional search. High-quality backlinks from relevant, authoritative domains tell Google that your content is trustworthy and valuable.</p>
        </section>

        <section className="mb-4">
          <h3 className="text-xl font-semibold text-gray-800 mb-2">Technical SEO</h3>
          <p className="text-gray-700 leading-relaxed">Site speed, mobile responsiveness, and crawl architecture all affect how well Google can discover, understand, and rank your content. A technically sound site removes barriers to indexing and ranking.</p>
        </section>

        <section className="mb-4">
          <h3 className="text-xl font-semibold text-gray-800 mb-2">Content Depth</h3>
          <p className="text-gray-700 leading-relaxed">Comprehensive, intent-satisfying content that thoroughly addresses the user's query. Long-form content with clear structure, supporting data, and visual elements tends to outperform thin or superficial pages.</p>
        </section>
      </section>

      <section className="my-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Case Study: HubSpot's SEO Strategy</h2>
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">Through 2024–2025, organic traffic reportedly declined from ~13.5M to ~8.6M as <Link to="/ai-search" className="text-teal-700 underline">AI Overviews</Link> began answering informational queries directly. Industry analysts coined the term <strong>"the HubSpot Shift"</strong> — not a penalty, but a redistribution of utility.</p>
          <p className="text-gray-700 leading-relaxed key-answer">The content strategy that made HubSpot dominant became insufficient on its own. The same informational queries they ranked #1 for were now being answered directly by AI, reducing the need for users to click through to the source.</p>
        </div>
      </section>

      <section className="my-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">The Traditional Search Success Formula</h2>
      ...
      <p className="text-gray-600 my-8">
        Understanding the traditional search model is essential context for understanding <Link to="/ai-search" className="text-teal-700 underline">how AI search works differently</Link> and why the <Link to="/landscape-shift" className="text-teal-700 underline">landscape is shifting</Link>.
      </p>
