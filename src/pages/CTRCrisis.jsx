...
export default function CTRCrisis() {
  return (
    <article>
      ...
      <header>
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">The CTR Crisis</h1>
      ...
      <section className="my-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">-61% Organic CTR Drop</h2>
      ...
      <section className="my-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">-68% Paid CTR Drop</h2>
      ...
      <section className="my-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">+35% Organic CTR Lift When Cited</h2>
      ...
      <section className="my-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">93% Zero-Click in AI Mode</h2>
      ...
      <section className="my-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">4.4x Higher Conversion Rate from AI Search Visitors</h2>
      ...
      <section className="my-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">-32% Fewer Clicks from Google Position #1</h2>
      ...
      <p className="text-gray-600 my-8">
        See the <Link to="/case-study" className="text-teal-700 underline">AcmeCRM case study</Link> for a concrete model of how these numbers affect a real business. For strategic responses, read <Link to="/brand-strategy" className="text-teal-700 underline">what this means for brands</Link>.
      </p>
