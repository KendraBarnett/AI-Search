...
export default function AISearch() {
  return (
    <article>
      ...
      <header>
        <h1 className="text-3xl sm:text-4xl font-bold text-brand-black mb-4">How AI Search Works</h1>
      ...
      <section className="my-10">
        <h2 className="text-2xl font-bold text-brand-black mb-4">The Four-Step AI Search Model</h2>

        <section className="mb-6">
          <h3 className="text-xl font-semibold text-brand-dark mb-2">1. Interpret — Semantic Intent Understanding</h3>
          <p className="text-brand-dark leading-relaxed">AI converts queries into <dfn>vector representations</dfn> — mathematical representations of text in multi-dimensional space. This allows the system to understand full context, follow-up questions, and true intent. Unlike traditional search keyword matching, AI comprehends the complete meaning of a query, including nuance, ambiguity, and implied needs.</p>
        </section>

        <section className="mb-6">
          <h3 className="text-xl font-semibold text-brand-dark mb-2">2. Retrieve — Retrieval-Augmented Generation (RAG)</h3>
          <p className="text-brand-dark leading-relaxed key-answer">The model doesn't just generate from training data — it actively retrieves passages from the live web, knowledge bases, and training corpus. <dfn>RAG (Retrieval-Augmented Generation)</dfn> embeds queries and candidate passages into the same vector space and performs similarity matching. This grounds the AI's response in real, verifiable sources rather than relying solely on pattern-learned knowledge.</p>
        </section>

        <section className="mb-6">
          <h3 className="text-xl font-semibold text-brand-dark mb-2">3. Synthesize — Cross-Reference and Weigh</h3>
          <p className="text-brand-dark leading-relaxed">The system cross-references multiple sources for agreement. Authority is driven by brand search volume, web mentions, and branded anchors — not PageRank. Low-confidence content is dropped. Sources that agree with each other on factual claims receive higher weighting in the final response.</p>
        </section>

        <section className="mb-6">
          <h3 className="text-xl font-semibold text-brand-dark mb-2">4. Generate — Direct Answer with Citations</h3>
          <p className="text-brand-dark leading-relaxed">The AI delivers a direct, synthesized answer with inline citations to source material. This often satisfies the user without a click — creating the <Link to="/ctr-crisis" className="text-brand-black underline">zero-click phenomenon</Link> that is reshaping digital marketing economics.</p>
        </section>
      </section>

      <section className="my-10">
        <h2 className="text-2xl font-bold text-brand-black mb-4">How Different AI Platforms Retrieve</h2>
        <p className="text-brand-dark leading-relaxed mb-6 key-answer">Understanding platform-specific retrieval differences is critical for <Link to="/seo-vs-aio" className="text-brand-black underline">AI Optimization (AIO)</Link> strategy. Only 11% of domains are cited by both ChatGPT and Perplexity — optimization strategies must differ by platform.</p>

        <section className="mb-6 bg-white border border-brand-light rounded-lg p-6">
          <h3 className="text-xl font-semibold text-brand-dark mb-2">Perplexity</h3>
          <p className="text-brand-dark leading-relaxed">Real-time web retrieval against a proprietary index of <strong>200+ billion URLs</strong>. Processes tens of thousands of indexing operations per second across 400+ petabytes of storage. Most similar to traditional search in citation behavior — Perplexity cites sources more frequently and transparently than other AI platforms.</p>
        </section>

        <section className="mb-6 bg-white border border-brand-light rounded-lg p-6">
          <h3 className="text-xl font-semibold text-brand-dark mb-2">ChatGPT</h3>
          <p className="text-brand-dark leading-relaxed">Blends training data with live browsing when search is triggered. Commercial intent prompts trigger web search <strong>53.5%</strong> of the time vs. 18.7% for informational queries. Users' opening questions trigger searches; follow-ups rarely do. ChatGPT cites only <strong>15%</strong> of the pages it retrieves — making each citation highly selective and competitive.</p>
        </section>

        <section className="mb-6 bg-white border border-brand-light rounded-lg p-6">
          <h3 className="text-xl font-semibold text-brand-dark mb-2">Google AI Overviews</h3>
          <p className="text-brand-dark leading-relaxed">Pulls from Google's own index using Gemini models. Uses <dfn>query fan-out</dfn> — issuing multiple related sub-queries simultaneously to build comprehensive responses. AI Overviews now appear in ~16% of global queries. <strong>92.36%</strong> of AI Overview responses link to at least one top-10 organic result.</p>
        </section>
      </section>

      <section className="my-10">
        <h2 className="text-2xl font-bold text-brand-black mb-4">How Brands Win with AI Optimization</h2>

        <section className="mb-4">
          <h3 className="text-xl font-semibold text-brand-dark mb-2">Authority</h3>
          <p className="text-brand-dark leading-relaxed key-answer">Brand search volume is the strongest predictor of AI citations (<strong>0.334 correlation</strong>) — stronger than backlinks. Brands in the top 25% for web mentions earn 10x more AI Overview mentions. Presence on trust platforms (G2, Trustpilot, Reddit) gives 3x higher citation probability.</p>
        </section>

        <section className="mb-4">
          <h3 className="text-xl font-semibold text-brand-dark mb-2">Structure</h3>
          <p className="text-brand-dark leading-relaxed">Format content for AI extraction — TL;DR summaries, FAQ schema, HowTo schema, clear passage boundaries. Pages with FCP under 0.4 seconds average <strong>6.7 ChatGPT citations</strong> vs. 2.1 for slower pages.</p>
        </section>

        <section className="mb-4">
          <h3 className="text-xl font-semibold text-brand-dark mb-2">Entity Clarity</h3>
          <p className="text-brand-dark leading-relaxed">Define who you are consistently across every surface. Organization and Person schema. Consistent terminology. If your brand means different things on different pages, AI loses confidence in citing you.</p>
        </section>

        <section className="mb-4">
          <h3 className="text-xl font-semibold text-brand-dark mb-2">Directness</h3>
          <p className="text-brand-dark leading-relaxed">Lead with the answer. Don't make the model dig for it. AI systems prioritize content that immediately addresses user intent — answer-first formatting is essential for citation.</p>
        </section>
      </section>

      <section className="my-10">
        <h2 className="text-2xl font-bold text-brand-black mb-4">The AI Search Success Formula</h2>
      ...
      <p className="text-brand-mid my-8">
        Compare this model with <Link to="/traditional-search" className="text-brand-black underline">how traditional search works</Link>, or see the <Link to="/comparison" className="text-brand-black underline">side-by-side comparison</Link>. To understand the business impact, read about <Link to="/ctr-crisis" className="text-brand-black underline">the CTR crisis</Link>.
      </p>
